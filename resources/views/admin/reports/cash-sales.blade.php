    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-12" >
                    ...
                    <div class="col-sm-6">
                        <div class="text-right" style="font-family: Aller">
                            <h1 style="font-size: 50px"><b>CASH SALE REPORT</b></h1>
                            <br/>
                        </div>
                ...
                {{--<h3> Doctor</h3>--}}
                <div>
                    {{--<p><i>SALE AMOUNT OF THE PLOT:</i> <b>{{ $sales->sale_price ?? '' }}</b></p>--}}
                    {{--<p><i>DOWN PAYMENT OF THE PLOT:</i> <b>{{$sales->down_payment ?? ''}}</b></p>--}}
                </div>
                <div class="row mb-12" >
                    {{--<div class="col-sm-2">--}}
                            ...
                            <table class="table table-striped">
                                ...
                                {{--@foreach($installments as $key => $installment)--}}
                                    {{--<tr data-entry-id="{{ $installment->id }}">--}}
                                        ...
                                        {{--</td>--}}
                                        {{--<td>--}}
                                            {{--{{ ($installment->Sales->sale_price-$installment->Sales->down_payment)/$installment->Sales->no_of_installments?? '' }}--}}
                                        {{--</td>--}}
                                        {{--<td>--}}
                                        {{--{{ $installment->Sales->sale_price ?? '' }}--}}
                                        {{--</td>--}}
                                        {{--<td>--}}
                                            {{--{{ $installment->receive_amount ?? '' }}--}}
                                        {{--</td>--}}
                                        {{--<td>--}}
