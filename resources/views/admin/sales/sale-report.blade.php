                ...
                <div class="row mb-12" >
                    ...
                    <div class="col-sm-6">
                        <div class="text-right" style="font-family: Aller">
                            <h1 style="font-size: 50px"><b>Sale Report</b></h1>
                            <br/>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr data-entry-id="{{ $sales->id }}">
                                        ...
                                        <td>
                                            <?php
                                            echo number_format($sales->sale_price/$sales->no_of_installments?? '')
                                            ?>
                                        </td>

                                        <td>
                                            {{ $sales->no_of_installments ?? '' }}
                                        </td>
                                        <td>
                                            <?php
                                            echo number_format($sales->sale_price-$sales->down_payment)
                                                ?>
                                        </td >
                                        {{--<td>--}}
