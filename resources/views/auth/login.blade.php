                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <h1>
                            <div class="login-logo text-center">
                                <img  class="img-responsive" src="{{asset('public/images/logo-small.png')}}" width="30%"  alt="Smiley face" >
                                <a style="margin-left: 30px;"> <br>
                                    Login
                        ...
                        <div class="row">
                            <div class="col-6">
                                <input type="submit" class="btn btn-success px-4" value='{{ trans('global.login') }}'>
                                <label class="ml-2">
